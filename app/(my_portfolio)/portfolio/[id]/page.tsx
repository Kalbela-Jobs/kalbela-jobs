...
const ShareProfilePage: React.FC<ShareProfilePageProps> = ({ params: { id } }) => {
    ...
    return (
        <div>
            <div className="bg-primary py-2 text-sm md:px-4 px-2 flex items-center gap-2 justify-center text-white">
                <span className="flex items-center gap-1">Power By <Link className="text-blue-500" href={`/`}>Kalbela Jobs</Link></span> |
                <Link className="text-blue-500" href={`/user/profile?tab=overview`}>Edit</Link> |
