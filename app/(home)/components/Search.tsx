...
export default function SearchModal(props: SearchModalProps) {
      ...
      return (
            <>
                  {/* Backdrop */}
                  {isModalOpen && (
                        <div className="fixed -top-10 inset-0 bg-black/40 backdrop-blur-sm z-[50000]" onClick={() => setIsModalOpen(false)} />
                  )}
                  {isModalOpen &&
                        <div className='z-[500000]'>
                              {theme !== 'dark' ? <img className='w-80' src="https://kalbelajobs.com/logo.png" alt="Kalbela Jobs Logo" /> : <img className='w-80' src="https://kalbelajobs.com/logo_dark.png" alt="Kalbela Jobs Logo" />}
                        </div>}
                  ...
                  >
                        ...
                        <div className="hidden items-center z-[500000] md:flex">
