                  ...
                  <div className=" items-center border-green-600  grid md:grid-cols-4 gap-2">
                        ...
                        <div className="">
                              <div className="flex gap-3 items-center justify-between">
                                    <button className="bg-[#001968] text-white px-3 py-1 w-full text-sm rounded">জনপ্রিয়</button>
                                    <button className="bg-[#001968] text-white px-3 py-1 w-full text-sm rounded">সাম্পতিক </button>
                                    <button className="bg-[#001968] text-white px-3 py-1 w-full text-sm rounded">পূর্ববর্তী</button>
                              </div>
                        </div>
